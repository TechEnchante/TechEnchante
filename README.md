...
As a passionate technologist, I’m driven by the evolving frontiers of **AI**, **cybersecurity**, and **automation**. With a strong foundation in **Python**, **Bash**, and **PowerShell**, I specialize in scripting solutions that solve complex security problems, automate investigations, and enable intelligent systems.

Recently, I’ve pivoted my focus toward:
- 🔐 Cybersecurity scripting for vulnerability analysis, alert enrichment, and SOC automation  
- 🤖 AI-driven tools for semantic search, task automation, and multi-agent coordination  
- 🛡️ Building resilient infrastructure using automation and zero-trust principles  

Though personal project time is scarce, I continue to tinker with:
- Python-based AI assistants for cybersecurity
- Infrastructure automation scripts
- LLM-powered tools for knowledge management
...
![AI](https://img.shields.io/badge/AI-LLM%20Applications-7D3C98?style=for-the-badge&logo=openai&logoColor=white)
![Cybersecurity](https://img.shields.io/badge/Cybersecurity-Scripting-2E8B57?style=for-the-badge&logo=hack-the-box&logoColor=white)
